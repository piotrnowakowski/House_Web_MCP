...
import original from '../../project-data/zielonki/before-road-controls-r51.json'
import front from '../../project-data/zielonki-v2/before-road-controls-r69.json'
import rear from '../../project-data/zielonki-rear-carport/before-road-controls-r90.json'
