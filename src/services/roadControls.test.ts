...
import original from '../../project-data/zielonki/before-facade-windows-r52.json'
import front from '../../project-data/zielonki-v2/before-facade-windows-r70.json'
import rear from '../../project-data/zielonki-rear-carport/before-facade-windows-r91.json'
