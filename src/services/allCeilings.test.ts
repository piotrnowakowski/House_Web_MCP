...
import front from '../../project-data/zielonki-v2/before-utility-buffer-r72.json'
...
import bath from '../../project-data/zielonki-rear-bath-room/before-ground-bathroom-b-r7.json'
