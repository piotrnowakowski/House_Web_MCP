...
import original from '../../project-data/zielonki/before-ceiling-r53.json'
import originalBase from '../../project-data/zielonki/before-facade-windows-r52.json'
import front from '../../project-data/zielonki-v2/before-ceiling-r71.json'
import frontBase from '../../project-data/zielonki-v2/before-facade-windows-r70.json'
import rear from '../../project-data/zielonki-rear-carport/before-recessed-terrace-r92.json'
