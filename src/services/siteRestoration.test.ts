...
import original from '../../project-data/zielonki/before-triangle-windows-r50.json'
import front from '../../project-data/zielonki-v2/before-triangle-windows-r68.json'
import rear from '../../project-data/zielonki-rear-carport/before-triangle-windows-r89.json'
