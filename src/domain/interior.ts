...
export const interiorCatalog: { id: InteriorCatalogId; name: string; category: string; size: [number, number, number]; color: string }[] = [
  ...
  { id: 'thermal-buffer', name: 'Thermal buffer tank · 1500 l planning envelope', category: 'Utility', size: [1.2, 1.2, 2.2], color: '#D9DEE0' },
  ...
  { id: 'compact-freestanding-bathtub', name: 'Compact freestanding bath', category: 'Bathroom', size: [0.72, 1.5, 0.6], color: '#F3EFE7' },
  { id: 'bathroom-step-cabinet', name: 'Shallow bathroom wall cabinet', category: 'Bathroom', size: [0.28, 0.18, 0.36], color: '#6E4932' },
