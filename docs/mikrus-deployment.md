...
## Triangular garage windows — 2026-09-12

All three current projects use mirrored triangular upper glazing at the garage-facing front-barn gable. Narrow variants fit the glass to the available roof inset. Lower windows/doors and roof geometry are retained. Pre-change snapshots r50/r68/r89 are tracked as before-triangle-windows files; immutable migration baselines stay intact. Release checks cover all 416 unit tests, TypeScript, the production build and the documented browser flows. Actual localhost and Chrome HTTP-origin workspaces were captured and compared before publishing; historical conflicting records remain preserved. See project-data READMEs for provenance.


## Four-part front glazing and aligned kitchen-bedroom windows — 2026-09-12

Projects r53/r71/r92 contain the four front openings and aligned kitchen/bedroom glazing from the user reference photos. Previous canonical snapshots are retained as `before-facade-windows-r52/r70/r91.json` in their respective project directories. Host deletion, independent edits and save/reload are covered by the 429-test suite. Building placement and roof geometry are unchanged. See the project READMEs for browser capture, historical original-workspace conflicts and merge provenance.


## Recessed terrace release — 2026-09-14
...
## Joined floors and facade corrections — 2026-09-14

Authorized house-branch release: original r54, front r72, rear r119, bathroom alternative r7. All current house designs use a 0.50 m upper slab with preserved living/dining voids, 3.75 m upper-floor elevation and aligned compliant main ridges. Slab contour winding, roof-edge cladding and recessed facade lining are corrected. Three-origin backup/comparison evidence, browser regressions and live audits are retained under ignored `tmp/ceilings-release/`. Earlier project baselines remain immutable and historical conflicts remain recoverable.
